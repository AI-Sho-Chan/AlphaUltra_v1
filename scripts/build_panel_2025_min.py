...
FEAT="data/proc/features_tdnet/tdnet_event_features.parquet"
PX  ="data/proc/prices/jp_prices_std.parquet"
OUT ="data/proc/dataset/tdnet_panel.parquet"
Path("data/proc/dataset").mkdir(parents=True, exist_ok=True)
...
print({"panel_rows": len(panel), "tickers": int(panel["ticker"].nunique()) if len(panel) else 0})
